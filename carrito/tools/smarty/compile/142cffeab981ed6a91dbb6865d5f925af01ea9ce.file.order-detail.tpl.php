<?php /* Smarty version Smarty-3.0.7, created on 2011-12-01 04:10:00
         compiled from "/home/libhb/public_html/carrito/themes/prestashop/order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6817941924ed728489733c5-28853070%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '142cffeab981ed6a91dbb6865d5f925af01ea9ce' => 
    array (
      0 => '/home/libhb/public_html/carrito/themes/prestashop/order-detail.tpl',
      1 => 1322709273,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6817941924ed728489733c5-28853070',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_function_counter')) include '/home/libhb/public_html/carrito/tools/smarty/plugins/function.counter.php';
?>
...
<?php }?>
<?php if ($_smarty_tpl->getVariable('order')->value->recyclable&&isset($_smarty_tpl->getVariable('isRecyclable',null,true,false)->value)&&$_smarty_tpl->getVariable('isRecyclable')->value){?>
...
<?php }?>
<br />
<ul class="address item" <?php if ($_smarty_tpl->getVariable('order')->value->isVirtual()){?>style="display:none;"<?php }?>>
...
<ul class="address alternate_item <?php if ($_smarty_tpl->getVariable('order')->value->isVirtual()){?>full_width<?php }?>">
